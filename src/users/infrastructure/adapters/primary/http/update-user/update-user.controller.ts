...
import { IUpdateUserController } from '../../../../../domain/ports/primary/api/update.controller.interface';
...
export class UpdateUserController
  implements IUpdateUserController<UpdateRequestDto, UserResponseDto>
{
