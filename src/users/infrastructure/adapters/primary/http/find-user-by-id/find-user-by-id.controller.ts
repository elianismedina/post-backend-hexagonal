...
import { IFindUserByIdController } from '../../../../../domain/ports/primary/api/find-user-by-id.controller.interface';
...
export class FindUserByIdController
  implements IFindUserByIdController<string, UserResponseDto>
{
