...
import { IUsersSignUpController } from '../../../../../domain/ports/primary/http/signup.controller.interface';
...
export class SingUpController
  implements IUsersSignUpController<SignUpRequestDto, UserResponseDto>
{
  ...
  async signup(@Body() body: SignUpRequestDto): Promise<UserResponseDto> {
    const user: UserResponseDto = await this.singUpService.signup(
      body.email,
      body.password,
    );
    return user;
